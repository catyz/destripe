...
for i in tqdm(range(n_sims)):
    ...
    restored_map_ext = mask*ground_map + (1-mask)*wienered_sat_map
...
#     f_PCL = nmt.NmtField(mask_apo, [filtered_ground_map[1], filtered_ground_map[2]], purify_b=False)
